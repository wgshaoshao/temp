...
@interface DrawAwardController ()<UIWebViewDelegate,UIScrollViewDelegate>
@property (nonatomic, strong) UIWebView *webView;
@property (nonatomic, strong) UIView *navigationBarView;

@end

@implementation DrawAwardController
...
- (void)initSubviews{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/asg/portal/watchaward/list.do",SITE_URL];
    
    //@"http://101.251.204.195:8080/asg/portal/watchaward/list.do";
...
- (void)webViewDidStartLoad:(UIWebView *)webView{
    ...
    [SVProgressHUD showWithStatus:@"加载抽奖页面中..."];
}
