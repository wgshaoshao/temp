...
-(void)creatUI{
    ...
    [refreshBtn setImage:[UIImage imageNamed:@"search_icon_refresh_s"] forState:UIControlStateNormal];
...
- (void)refreshBtnClick{
    ...
    if ([self.delegate respondsToSelector:@selector(allHotSearchRefreshBtn)]) {
        [self.delegate allHotSearchRefreshBtn];
    }
}
