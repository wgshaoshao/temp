...
- (NSDictionary *)coreTextAttributes
{
    ...
    paragraphStyle.paragraphSpacing = font_.pointSize / 1.7;
    
    paragraphStyle.alignment = NSTextAlignmentLeft;
    NSDictionary *dic = nil;
    if (_isNightTextColor) {
        dic = @{NSParagraphStyleAttributeName: paragraphStyle, NSFontAttributeName:font_,NSForegroundColorAttributeName:ADColor(100, 100, 100)};

    } else {
        dic = @{NSParagraphStyleAttributeName: paragraphStyle, NSFontAttributeName:font_,NSForegroundColorAttributeName:ADColor(70, 70, 70)};
    }
    return dic;
}
