...
@implementation NewThreeOrderView
...
- (void)autoBtnClick:(UIButton *)button{
    ...
    if ([self.delegate respondsToSelector:@selector(newThreeOrderViewAutoBuyBtnClick:)]) {
        [self.delegate newThreeOrderViewAutoBuyBtnClick:button];
    }
}
...
- (void)ensureClick:(EnsureButton *)button{
    ...
    if ([self.delegate respondsToSelector:@selector(newThreeOrderViewEnsureBtnClick:)]) {
        [self.delegate newThreeOrderViewEnsureBtnClick:button];
    }
}
...
- (void)closeBtnClick{
    ...
    if ([self.delegate respondsToSelector:@selector(newThreeOrderViewCancelBtnClick)]) {
        [self.delegate newThreeOrderViewCancelBtnClick];
    }
