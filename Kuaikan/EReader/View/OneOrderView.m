...
- (void)ensureClick:(EnsureButton *)button{
    ...
    if ([self.delegate respondsToSelector:@selector(oneOrderViewEnsureBtnClick:)]) {
        [self.delegate oneOrderViewEnsureBtnClick:button];
    }
}
...
- (void)closeBtnClick{
   ...
   // if ([self.delegate respondsToSelector:@selector(oneOrderViewCancelBtnClick)]) {
    //    [self.delegate oneOrderViewCancelBtnClick];
   // }
