...
@implementation NewTwoOrderView
...
- (void)autoBtnClick:(UIButton *)button{
    ...
    if ([self.delegate respondsToSelector:@selector(newTwoOrderViewAutoBuyBtnClick:)]) {
        [self.delegate newTwoOrderViewAutoBuyBtnClick:button];
    }
}
...
- (void)ensureClick:(EnsureButton *)button{
    ...
    if ([self.delegate respondsToSelector:@selector(newTwoOrderViewEnsureBtnClick:)]) {
        [self.delegate newTwoOrderViewEnsureBtnClick:button];
    }
}
...
- (void)closeBtnClick{
    ...
    if ([self.delegate respondsToSelector:@selector(newTwoOrderViewCancelBtnClick)]) {
        [self.delegate newTwoOrderViewCancelBtnClick];
    }
