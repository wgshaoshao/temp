...
//总标题数组
@property (nonatomic, strong) NSMutableArray *totalTitlArray;
//目录数组
@property (nonatomic, strong) NSMutableArray *chapterIdListArray;
 ...
 *  @return 该章节内容
 */
- (E_EveryChapter *)openChapterContent:(NSString *)contentStr;
