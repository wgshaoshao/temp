...
- (void)positionHUD:(NSNotification*)notification {
    ...
    switch (orientation) {
        ...
        case UIInterfaceOrientationLandscapeLeft:
            ...
            //rotateAngle = 0.0;
            newCenter = CGPointMake(posY + 50.0, posX);
            break;
        case UIInterfaceOrientationLandscapeRight:
            if ([[[UIDevice currentDevice]systemVersion]floatValue] >= 8.1)
            {
            ...
            //rotateAngle = 0.0;
            newCenter = CGPointMake(orientationFrame.size.height-posY - 50.0, posX);
            break;
...
- (CGPoint)pointOnCircleWithCenter:(CGPoint)center radius:(double)radius angleInDegrees:(double)angleInDegrees {
    CGFloat x = (float)(radius * cos(angleInDegrees * M_PI / 180)) + radius;
    CGFloat y = (float)(radius * sin(angleInDegrees * M_PI / 180)) + radius;
