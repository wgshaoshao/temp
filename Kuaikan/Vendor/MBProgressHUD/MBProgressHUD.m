...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		_progress = 0.f;
		_MBlineColor = [UIColor whiteColor];
...
- (void)drawRect:(CGRect)rect {
	...
	CGContextSetStrokeColorWithColor(context,[_MBlineColor CGColor]);
...
- (NSArray *)observableKeypaths {
	return [NSArray arrayWithObjects:@"MBlineColor", @"progressRemainingColor", @"progressColor", @"progress", nil];
}
